<div class="container padding">
    <div class="panel panel-default">
        <div class="panel-head">
            ...
            <a class="btn pull-left btn-sm btn-primary" href="<?= site_url('pages/lists') ?>"><?= lang('pages_back_to_menu') ?></a>
        </div>
...
<form method="post">
    ...
    <div class="form-group">
        ...
        <input type="text" required=""  value="<?php echo set_value('name',$name); ?>" class="form-control" id="name" name="name" />
    </div>
    
    <div class="form-group">
        <label for="title"><?=lang('pages_title');?>  :</label>
        <input type="text" required=""  value="<?php echo set_value('title',$title); ?>" class="form-control" id="title" name="title">
    </div>
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" name="content" id="description"><?php echo set_value('content',$content); ?></textarea>
    </div>
